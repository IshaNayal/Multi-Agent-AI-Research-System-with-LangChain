...
if st.session_state.running and not st.session_state.done:
    ...
    # ── Step 2: Reader ──
    if "search" in results and "reader" not in results:
    ...
    # ── Step 3: Writer ──
    if "reader" in results and "writer" not in results:
    ...
    # ── Step 4: Critic ──
    if "writer" in results and "critic" not in results:
    ...
    # Mark as done when all steps complete
